<?php
    ...
    function generateRandomDate($startDate, $endDate)
    {
        ...
        {
            $addresses = ['Nagoya', 'Kitakyushu', 'Sendai', 'Hiroshima' ,'Kawasaki', 'Kyoto','Kobe','Fukuoka','Sapporo','Osaka','Yatsushiro','Higashimatsuyama','Nagasaki','Takarazuka','Mishima','Odawara','Matsumoto','Ginowan','Toda','Funabashi','Ise','Nagawa','Tagajo','Akita','Yokohama','Obihiro','Naha','Tokyo'];
